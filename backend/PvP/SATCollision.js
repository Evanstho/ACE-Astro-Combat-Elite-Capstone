export class RectangleBody{
    constructor(x, y, width, height, rotation){
        ...
        // both bullets and ships are drawn to point to (0,0) by default 
        // but we use them rotated 270 degrees in game 
        this.vertices = 
    ...
    rotate(angle){
        // given an angle in radians this rorates all vertices of the rectangle in place
        this.rotation = angle ;
        // this.rotation is correct since we got it directly from Phaser 
        // but the equation for rotation around a point expects counterclockwise rotation
        // multiplying the angle by -1 accounts for how phaser uses clockwise rotation / Y axis beinginverted
    ...
    getNormals(){ // this.vertices = [ [x,y],[x,y] ....]
